...
namespace product_manager.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductCategoryId,ProductName,ProductDescription,ProductPrice")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductCategoryId,ProductName,ProductDescription,ProductPrice")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
